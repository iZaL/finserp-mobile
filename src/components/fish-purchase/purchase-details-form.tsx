...
export function PurchaseDetailsForm({
  ...
  const handleChange = (
    field: keyof PurchaseDetailsStepFormData,
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="space-y-2">
            ...
            {errors.bill_number && (
              <p className="text-destructive text-xs">{errors.bill_number}</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Truck className="text-muted-foreground absolute top-1/2 left-3 size-4 -translate-y-1/2" />
              <Input
                id="vehicle_number"
          ...
          <div className="space-y-2">
            ...
            {errors.driver_name && (
              <p className="text-destructive text-xs">{errors.driver_name}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <Select
              value={
                formData.fish_location_id && formData.fish_location_id > 0
                  ? formData.fish_location_id.toString()
                  : undefined
              }
              onValueChange={(value) =>
      ...
      <Dialog open={showLocationDialog} onOpenChange={setShowLocationDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {t('addLocationDialog.description')}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="location_name">
                {t('addLocationDialog.locationName')}{' '}
          ...
          <DialogFooter>
            ...
            >
              {addingLocation
                ? t('addLocationDialog.adding')
                : t('addLocationDialog.add')}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
