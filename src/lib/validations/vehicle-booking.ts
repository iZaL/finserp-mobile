...
export const rejectVehicleSchema = z
  .object({
    rejection_reason: z.enum(
      REJECTION_REASONS as unknown as [string, ...string[]],
      {
  ...
  .refine(
    ...
    {
      message:
        "Additional notes are required when selecting 'Other' as rejection reason",
...
export const bulkActionSchema = z.object({
  ...
  data: z.union([receiveVehicleSchema, rejectVehicleSchema]).optional(),
});
...
>;
export type UpdateVehicleBookingInput = z.infer<
  typeof updateVehicleBookingSchema
>;
