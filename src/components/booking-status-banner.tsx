 ...
 */
export function BookingStatusBanner({ isEnabled, className }: BookingStatusBannerProps) {
  ...
  return (
    ...
    >
      ...
      <AlertTitle className="!text-red-900 dark:!text-red-100 font-semibold text-sm mb-1">
 ...
 */
export function CompactBookingStatusBanner({ isEnabled, className }: BookingStatusBannerProps) {
  const t = useTranslations();
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-2 rounded-lg border-2 border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950/20 px-3 py-2 text-sm",
    ...
    >
      ...
      <div className="flex-1">
        ...
        <p className="text-xs text-red-800 dark:text-red-200 opacity-90">
          {t("bookingStatus.closedDescription")}
        </p>
      </div>
    </div>
